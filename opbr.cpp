...
int main() {
    ...
    int totalplays = 0;
    float percvalue = 0;
    int perc10, perc20, perc30, perc40, perc50, perc60, perc70, perc80, perc90, perc100 = 0;
        int percentages [101] = { };
    int maincounttest = 0;
    int incdayscount = 0;
    int filesize = 30785141; // 01
    float value = 0;
                ...
                while ((pos = line.find(delimiter)) != string::npos) {
                        ...
                        if (count==0) {
                            ...
                            //if (maincount == 1) {
                                ...
                                percvalue = (value/filesize)*100;
                                for (int i = 0; i < 100; ++i)
                                {
                                    if(percvalue < i+1 && percvalue > i-1) {
...
*/
        ...
        for (int i = 0; i < 100; ++i)
        {
            cout << i << " Percentage: " << percentages[i] << endl;
            outputfile << percentages[i] << endl;
        }
